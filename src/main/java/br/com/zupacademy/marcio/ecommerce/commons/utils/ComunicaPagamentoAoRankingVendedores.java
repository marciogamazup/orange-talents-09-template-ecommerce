...
@Component
public class ComunicaPagamentoAoRankingVendedores {

    public void libera(Compras compras, Pagamentos pagamentos) {

        System.out.println("Comunicado: ");
        System.out.println("Liberado para atualizar o ranking dos vendedores sobre a conclusão " +
                            "faturamento da compra de id: "+compras.getId()+
